...
export default function HowToGetMoreCustomers() {
  return (
    <ResourceLayout
      title="How to Get More Customers for Your Small Business in Canada | SalesLeadIT"
      description="Proven strategies to get more customers for your small business in Canada. SalesLeadIT delivers exclusive local leads in 7–30 days. Surrey, BC. Canada-wide."
      canonical="https://salesleadit.com/resources/how-to-get-more-customers-for-small-business-canada"
